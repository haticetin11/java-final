package com.example.javafinal.ui.adapter;
...
import com.example.javafinal.R; // Bu içe aktarma ifadesini, projenizin R.java dosyasının paketi ile doğru bir şekilde değiştirin
